...
const AboutPage = () => (
  <div className="flex justify-center items-center min-h-[60vh] px-4 bg-gray-100">
    <div className="bg-white rounded-2xl shadow-2xl border border-gray-300 max-w-2xl w-full p-8 mt-10">
      <h1 className="text-3xl font-bold mb-4 text-blue-600">About FoodieExpress</h1>
      <p className="mb-4 text-gray-700">
        FoodieExpress is your one-stop solution for ordering delicious food from your favorite restaurants and cafes. 
      ...
      <div className="text-sm text-gray-500">
        Thank you for choosing FoodieExpress. We are committed to making your food ordering experience delightful!
      </div>
    </div>
  </div>
);
